...
import SignInForm from "./SignInDefault.jsx";
import SignInFormRight from "./SigninRight.jsx";
import SignInFormLeft from "./SigninLeft.jsx";
import { Link } from "react-router-dom";
import { SimpleTreeView } from "@mui/x-tree-view/SimpleTreeView";
import { TreeItem } from "@mui/x-tree-view/TreeItem";
import { Prism as SyntaxHighlighter } from "react-syntax-highlighter";
import code from "./SignInDefault.jsx?raw";
import code2 from "./SigninRight.jsx?raw";
import code3 from "./SigninLeft.jsx?raw";
import {
  materialLight,
  materialDark,
        ...
        <div className="m-8 text-black dark:text-white ">
          ...
          >
            <div className="flex justify-between items-center w-full">
              <div className="flex">
                <span className="text-xl">Sign In Default</span>
              </div>
              <div className="ml-auto flex space-x-2">
                ...
                <Link to={"/view/form/signin/default"}>
          ...
          >
            <div className="flex justify-between items-center w-full">
              <div className="flex-1">
                <span className="text-xl">Sign In Right</span>
              </div>
              <div className="ml-auto flex space-x-2">
                <button
                ...
                <Link to={"/view/form/signin/rightside"}>
                  <button className="p-2 border border-neutral-500 dark:text-white rounded flex items-center">
                    <LuEye />
                  </button>
                </Link>
          ...
          >
            <div className="flex justify-between items-center w-full">
              <div className="flex-1">
                <span className="text-xl">Sign In Left</span>
              </div>
              <div className="ml-auto flex space-x-2">
                <button
