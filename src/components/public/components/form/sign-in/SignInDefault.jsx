...
function SignInForm() {
  ...
  const handleEmailChange = (event) => {
    ...
    // Allow input even if the email is not fully valid (for real-time typing)
    setEmail(value);

    // Validate only when the value matches the email pattern or is empty
  ...
  const handlePasswordChange = (event) => {
    ...
    // Check if the password matches the allowed characters
  ...
  //Set the visibility of show and hide button
  const togglePasswordVisibility = () => setShowPassword((prev) => !prev);

  //Set the visibility of remember me button
